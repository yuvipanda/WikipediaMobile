...
- (id)init
{
    ...
    NSDictionary *userAgentDictionary = [[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"WikipediaMobile/%@ %@", version, currentUserAgent], @"UserAgent", nil];
    [webView release];
...
// only valid if Wikipedia-iOS-Info.plist specifies a protocol to handle
